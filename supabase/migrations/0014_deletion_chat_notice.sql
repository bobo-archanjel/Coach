-- FitPilot — notifikácia klienta o GDPR zmazaní (0013_client_deletion.sql).
-- Spustiť v Supabase Dashboard → SQL Editor → New query → vložiť celý súbor → Run.
-- Predpokladá 0008 (messages) a 0013 (request_client_deletion/cancel_client_deletion). Idempotentné.
--
