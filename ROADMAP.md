...
**Číslovanie migrácií — ďalšie voľné číslo je `0031`.** Dohodnite si vopred, kto berie ktoré číslo, nech sa nezraziť dva rovnaké súbory na dvoch vetvách:
...
| 0030 | `ai_usage_roster_summary.sql` (rozšírenie `ai_usage.kind` CHECK o `roster_summary` — AI digest portfólia, `feature/analytika-v2`) | Zdieľané |
| 0031+ | — voľné — | dohodnúť |
