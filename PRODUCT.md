...
- AI moduly: kontextový chat pre klienta (s eskaláciou na trénera pri zdravotných témach, nediagnostikuje), AI asistent pre trénera (generovanie plánov/jedálničkov, sumarizácia progresu jedného klienta aj týždenný digest celého portfólia „na koho sa zamerať", upozornenia na nízku adherenciu). Appka spočíta čísla, model ich len formuluje.
